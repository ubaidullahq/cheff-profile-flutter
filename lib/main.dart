  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: <Widget>[
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage('assets/ubaidullah.jpg'),
                        fit: BoxFit.cover)),
              ),
            ),
            Positioned(
        ...
        Column(
          children: <Widget>[
            menuCard('Berry banana milkshake', 'assets/banana shake.webp',
                'Breakfast', 4, 2.8, 1.2),
            SizedBox(height: 12.0),
            menuCard('Fruit pancake', 'assets/bowl1.webp', 'Breakfast', 4,
                4.2, 2.8),
          ],
        ),
        ...
        Padding(
          ...
          child: Container(
            ...
            child: ListView(
              ...
              children: <Widget>[
                getWorks('assets/bowl1.webp'),
                getWorks('assets/shake1.webp'),
                getWorks('assets/banana shake.webp'),
                getWorks('assets/shake1.webp'),
              ],
            ),
          ),
